...
## 旧 2 周路线图速览（历史记录，非当前求职主线）

> 2026-07-21 纠偏：本节保留为历史学习记录，不再作为 app_v4 的工程目标。当前 app_v4 以求职和面试能力为主线，优先采用业界主流做法和可复现证据，不再按旧阶段或 PRD/演示材料驱动。

```
Week 1：
  Phase 1 (P0) ← 当前：安全加固
  Phase 2 (P0) ← 真 MCP Server（当时的最大缺口）
  Phase 3 (P1) ← 审批流
